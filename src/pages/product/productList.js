...
class ProductList extends Component {
  ...
  _renderList() {
    let data = [
      {key: 'a', source: imageSource.temp_image_card, text: '我的世界游戏周边'},
      {key: 'b', source: imageSource.temp_image_card, text: '我的世界游戏周边'},
      {key: 'c', source: imageSource.temp_image_card, text: '我的世界游戏周边'},
      {key: 'd', source: imageSource.temp_image_card, text: '我的世界游戏周边'},
      {key: 'e', source: imageSource.temp_image_card, text: '我的世界游戏周边'},
      {key: 'f', source: imageSource.temp_image_card, text: '我的世界游戏周边'},
      {key: 'g', source: imageSource.temp_image_card, text: '我的世界游戏周边'},
