        ...
        return (
            <View style={styles.phoneNumView.container}>
                <View style={styles.phoneNumView.wrapper}>
                    <TextInput placeholder="+86" placeholderTextColor={styles.placeholderTextColor} underlineColorAndroid={styles.underline} style={styles.phoneNumView.code}
                               keyboardType={styles.keyboardType} maxLength={3}/>
                </View>
                <View style={[styles.phoneNumView.wrapper, {marginLeft: 25, flex: 1}]}>
                    <TextInput placeholder="请输入手机号" placeholderTextColor={styles.placeholderTextColor} underlineColorAndroid={styles.underline} style={styles.phoneNumView.phone}
