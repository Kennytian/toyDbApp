    ...
    return (
      <View>
        ...
        <View style={{marginTop: 8, marginLeft: 8, marginRight: 8}}>
          <ReviewCard containerStyle={{backgroundColor: '#FFF'}} reviewerName="老五" reviewContent="所以一些可以生食的瓜果蔬菜更容易被污染，所以食物还是尽量做再吃，可以杀虫卵" replyContent="所以一些可以生食的瓜果蔬菜更容易被污染，所以食物还是尽量做熟了吃"
                      replyDate="2017-3-5" likeCount={1234} />
        </View>
      </View>
    );
  }
